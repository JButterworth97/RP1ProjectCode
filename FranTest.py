...
bamFile = "reference.bam"  ## Reads in bam file for the strain of interest as well as the reference fasta file.
...
fasta_sequences=SeqIO.parse(open("reference.fasta"), 'fasta') ##Opens fasta file and the strain of interest's bam file as a sam file. 
samfile = pysam.Samfile("reference.bam", "rb")
...
iterator = samfile.pileup( 'CP025551',start,stop) # what are start and stop
